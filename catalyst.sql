...
INSERT INTO `resources` (`ID`, `ENVIRONMENT`, `TYPE`, `PRIORITY`, `LOCAL`, `NAME`, `MINIFIED_NAME`, `VERSIONED`, `LATEST_SOURCE`, `DATE_OF_LATEST_UPGRADE`, `GITHUB_REPO_NAME`, `CHANGELOG_URL`, `CURRENT_VERSION`, `LATEST_VERSION`, `ATTRIBUTES`) VALUES(1, 'ALWAYS', 'SCRIPT', 0, 0, 'jquery.js', 'jquery.min.js', 1, 'TAG', '1970-01-01', 'jquery/jquery', 'https://blog.jquery.com/category/jquery/', '000000', '75f7e963708b60f37a42b777f35825d33c4f8e7a', '[]');
INSERT INTO `resources` (`ID`, `ENVIRONMENT`, `TYPE`, `PRIORITY`, `LOCAL`, `NAME`, `MINIFIED_NAME`, `VERSIONED`, `LATEST_SOURCE`, `DATE_OF_LATEST_UPGRADE`, `GITHUB_REPO_NAME`, `CHANGELOG_URL`, `CURRENT_VERSION`, `LATEST_VERSION`, `ATTRIBUTES`) VALUES(2, 'ALWAYS', 'SCRIPT', 1000, 0, 'materialize.js', 'materialize.min.js', 1, 'TAG', '1970-01-01', 'Dogfalo/materialize', 'https://github.com/Dogfalo/materialize/blob/v1-dev/CHANGELOG.md', '000000', '80e8ed370487aaf1e2185b028f7deda40da94eb9', '[\"defer\"]');
INSERT INTO `resources` (`ID`, `ENVIRONMENT`, `TYPE`, `PRIORITY`, `LOCAL`, `NAME`, `MINIFIED_NAME`, `VERSIONED`, `LATEST_SOURCE`, `DATE_OF_LATEST_UPGRADE`, `GITHUB_REPO_NAME`, `CHANGELOG_URL`, `CURRENT_VERSION`, `LATEST_VERSION`, `ATTRIBUTES`) VALUES(3, 'ALWAYS', 'SCRIPT', 1500, 0, 'draggable.bundle.legacy.js', 'draggable.bundle.legacy.min.js', 1, 'TAG', '1970-01-01', 'Shopify/draggable', 'https://github.com/Shopify/draggable/blob/master/CHANGELOG.md', '000000', 'c518fb184c7606feeda6d5d56aacc61ced0ec8fd', '[\"defer\"]');
INSERT INTO `resources` (`ID`, `ENVIRONMENT`, `TYPE`, `PRIORITY`, `LOCAL`, `NAME`, `MINIFIED_NAME`, `VERSIONED`, `LATEST_SOURCE`, `DATE_OF_LATEST_UPGRADE`, `GITHUB_REPO_NAME`, `CHANGELOG_URL`, `CURRENT_VERSION`, `LATEST_VERSION`, `ATTRIBUTES`) VALUES(4, 'ALWAYS', 'SCRIPT', 5000, 0, 'jsencrypt.js', 'jsencrypt.min.js', 1, 'TAG', '1970-01-01', 'travist/jsencrypt', 'http://travistidwell.com/jsencrypt', '000000', 'cc8a8c70f63e109d812c5052443610f678cc946d', '[\"defer\"]');
INSERT INTO `resources` (`ID`, `ENVIRONMENT`, `TYPE`, `PRIORITY`, `LOCAL`, `NAME`, `MINIFIED_NAME`, `VERSIONED`, `LATEST_SOURCE`, `DATE_OF_LATEST_UPGRADE`, `GITHUB_REPO_NAME`, `CHANGELOG_URL`, `CURRENT_VERSION`, `LATEST_VERSION`, `ATTRIBUTES`) VALUES(5, 'ALWAYS', 'SCRIPT', 5000, 0, 'aesjs.js', 'aesjs.min.js', 1, 'TAG', '1970-01-01', 'ricmoo/aes-js', 'https://github.com/ricmoo/aes-js/releases', '000000', '7c9fad4add4b349dcb89a4e2125f37defaef3bc8', '[\"defer\"]');
INSERT INTO `resources` (`ID`, `ENVIRONMENT`, `TYPE`, `PRIORITY`, `LOCAL`, `NAME`, `MINIFIED_NAME`, `VERSIONED`, `LATEST_SOURCE`, `DATE_OF_LATEST_UPGRADE`, `GITHUB_REPO_NAME`, `CHANGELOG_URL`, `CURRENT_VERSION`, `LATEST_VERSION`, `ATTRIBUTES`) VALUES(6, 'ALWAYS', 'SCRIPT', 5000, 0, 'sjcl.js', 'sjcl.min.js', 1, 'TAG', '1970-01-01', 'bitwiseshiftleft/sjcl', 'https://github.com/bitwiseshiftleft/sjcl/releases', '000000', '2a6ed4a22449334de2dd9b4e960af679e0e87303', '[\"defer\"]');
INSERT INTO `resources` (`ID`, `ENVIRONMENT`, `TYPE`, `PRIORITY`, `LOCAL`, `NAME`, `MINIFIED_NAME`, `VERSIONED`, `LATEST_SOURCE`, `DATE_OF_LATEST_UPGRADE`, `GITHUB_REPO_NAME`, `CHANGELOG_URL`, `CURRENT_VERSION`, `LATEST_VERSION`, `ATTRIBUTES`) VALUES(7, 'ALWAYS', 'SCRIPT', 100000, 0, 'cheet.js', 'cheet.min.js', 1, 'COMMIT', '1970-01-01', 'namuol/cheet.js', 'https://github.com/namuol/cheet.js/commits/master', '000000', '5c1a8e8f75539540f59330c0af34cfdf9b231b53', '[\"defer\"]');
...
INSERT INTO `resources` (`ID`, `ENVIRONMENT`, `TYPE`, `PRIORITY`, `LOCAL`, `NAME`, `MINIFIED_NAME`, `VERSIONED`, `LATEST_SOURCE`, `DATE_OF_LATEST_UPGRADE`, `GITHUB_REPO_NAME`, `CHANGELOG_URL`, `CURRENT_VERSION`, `LATEST_VERSION`, `ATTRIBUTES`) VALUES(20, 'ALWAYS', 'STYLE', 100, 0, 'materialize.css', 'materialize.min.css', 1, 'TAG', '1970-01-01', 'Dogfalo/materialize', 'https://github.com/Dogfalo/materialize/blob/v1-dev/CHANGELOG.md', '000000', '80e8ed370487aaf1e2185b028f7deda40da94eb9', '[]');
