...
class Color {
	...
	public const COLOR_BY_HEX = [
		'f44336' => ['e57373', 'ef5350', 'f44336', 'e53935', 'd32f2f', 'c62828', 'b71c1c', 'ff8a80', 'ff5252', 'ff1744', 'd50000'],
		'e91e63' => ['f06292', 'ec407a', 'e91e63', 'd81b60', 'c2185b', 'ad1457', '880e4f', 'ff80ab', 'ff4081', 'f50057', 'c51162'],
		'9c27b0' => ['ba68c8', 'ab47bc', '9c27b0', '8e24aa', '7b1fa2', '6a1b9a', '4a148c', 'ea80fc', 'e040fb', 'd500f9', 'aa00ff'],
		'673ab7' => ['9575cd', '7e57c2', '673ab7', '5e35b1', '512da8', '4527a0', '311b92', 'b388ff', '7c4dff', '651fff', '6200ea'],
		'3f51b5' => ['7986cb', '5c6bc0', '3f51b5', '3949ab', '303f9f', '283593', '1a237e', '8c9eff', '536dfe', '3d5afe', '304ffe'],
		'2196f3' => ['64b5f6', '42a5f5', '2196f3', '1e88e5', '1976d2', '1565c0', '0d47a1', '82b1ff', '448aff', '2979ff', '2962ff'],
		'03a9f4' => ['4fc3f7', '29b6f6', '03a9f4', '039be5', '0288d1', '0277bd', '01579b', '40c4ff', '00b0ff', '0091ea'],
		'00bcd4' => ['4dd0e1', '26c6da', '00bcd4', '00acc1', '0097a7', '00838f', '006064', '18ffff', '00e5ff', '00b8d4', '40e0d0'],
		'009688' => ['4db6ac', '26a69a', '009688', '00897b', '00796b', '00695c', '004d40', '64ffda', '1de9b6', '00bfa5'],
		'4caf50' => ['81c784', '66bb6a', '4caf50', '43a047', '388e3c', '2e7d32', '1b5e20', '69f0ae', '00e676', '00c853'],
		'8bc34a' => ['aed581', '9ccc65', '8bc34a', '7cb342', '689f38', '558b2f', '33691e', 'b2ff59', '76ff03', '64dd17'],
		'cddc39' => ['dce775', 'd4e157', 'cddc39', 'c0ca33', 'afb42b', '9e9d24', '827717', 'eeff41', 'c6ff00', 'aeea00'],
		'ffeb3b' => ['fff176', 'ffee58', 'ffeb3b', 'fdd835', 'fbc02d', 'f9a825', 'f57f17', 'ffff8d', 'ffff00', 'ffea00', 'ffd600'],
		'ffc107' => ['ffd54f', 'ffca28', 'ffc107', 'ffb300', 'ffa000', 'ff8f00', 'ff6f00', 'ffe57f', 'ffd740', 'ffc400', 'ffab00'],
		'ff9800' => ['ffb74d', 'ffa726', 'ff9800', 'fb8c00', 'f57c00', 'ef6c00', 'e65100', 'ffd180', 'ffab40', 'ff9100', 'ff6d00'],
		'ff5722' => ['ff8a65', 'ff7043', 'ff5722', 'f4511e', 'e64a19', 'd84315', 'bf360c', 'ff9e80', 'ff6e40', 'ff3d00', 'dd2c00'],
		'795548' => ['a1887f', '8d6e63', '795548', '6d4c41', '5d4037', '4e342e', '3e2723'],
		'9e9e9e' => ['bdbdbd', '9e9e9e', '757575', '616161', '424242', '212121'],
		'607d8b' => ['90a4ae', '78909c', '607d8b', '546e7a', '455a64', '37474f', '263238'],
		'000000' => ['000000']
	];
	...
	public static function lightenHex(string $hex, float $steps) : string {
		if (strlen($hex) == 3) {
			$hex = $hex[0].$hex[0].$hex[1].$hex[1].$hex[2].$hex[2];
		}
		$exploded = [$hex[0].$hex[1], $hex[2].$hex[3], $hex[4].$hex[5]];
