...
(function($){
	$(function(){
		...
		<?php require_once __DIR__.DIRECTORY_SEPARATOR.'image_upload_arranger.js.php'; ?>

		/* FILE PICKER */
		<?php require_once __DIR__.DIRECTORY_SEPARATOR.'file_picker.js.php'; ?>

		/* SUBFORM THING */
		<?php require_once __DIR__.DIRECTORY_SEPARATOR.'subform_entry_field.js.php'; ?>

		/* COLOR PICKER */
		<?php require_once __DIR__.DIRECTORY_SEPARATOR.'color_picker.js.php'; ?>

		/* TOGGLEABLE BUTTONS */
		<?php require_once __DIR__.DIRECTORY_SEPARATOR.'toggle_buttons.js.php'; ?>

		/* COMMISSION TYPES QUICK ACTIONS */
		<?php require_once __DIR__.DIRECTORY_SEPARATOR.'commission_types_quick_actions.js.php'; ?>

		/* COMMISSION TYPES REARRANGER */
		<?php require_once __DIR__.DIRECTORY_SEPARATOR.'commission_types_reorder.js.php'; ?>
		...
		/* SOCIAL MEDIA */
		<?php require_once __DIR__.DIRECTORY_SEPARATOR.'social_media.js.php'; ?>
		...
		/* ENCRPYTION */
		<?php require_once __DIR__.DIRECTORY_SEPARATOR.'encryption.js.php'; ?>

		/* COMMISSION TYPE ACTIONS */
		<?php require_once __DIR__.DIRECTORY_SEPARATOR.'commission_type_client_actions.js.php'; ?>

		/* IMAGE COMPRESSION FALLBACKS */
		<?php require_once __DIR__.DIRECTORY_SEPARATOR.'webp_background_image_fallback.js.php'; ?>
	});
})(jQuery);
