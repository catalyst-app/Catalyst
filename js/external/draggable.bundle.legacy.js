    ...
    value: function value(event) {
      ...
      if (dragEvent.canceled()) {
        ...
        requestAnimationFrame(function () {
          ...
          _this5[onDragMove](Object.assign({}, event, {
            target: _this5.source,
  ...
  (0, _createClass3.default)(ResizeMirror, [{
    ...
    value: function value(dragEvent) {
      ...
      requestAnimationFrame(function () {
        ...
        var overElement = dragEvent.over || _this2.draggable.getDraggableElementsForContainer(dragEvent.overContainer)[0];
...
$export($export.S + $export.F * !__webpack_require__(18), 'Object', { defineProperty: __webpack_require__(12).f });
