...
class ErrorCodes {
	...
	const ERR_90304 = 'Password was not entered';
	const ERR_90305 = 'Password does not meet the requirements';
	const ERR_90306 = 'Password confirmation was not entered';
	const ERR_90307 = 'Confirmation does not match the provided password';
	const ERR_90308 = 'Email is invalid';
	const ERR_90309 = 'Email is already in use';
	const ERR_90310 = 'Nickname is invalid';
	const ERR_90311 = 'The image is too large';
	const ERR_90312 = 'The image is not an image';
	const ERR_90313 = 'The image is invalid';
	const ERR_90314 = 'The NSFW profile picture checkbox is invalid';
	const ERR_90315 = 'Color was not entered';
	const ERR_90316 = 'The color is not a valid color';
