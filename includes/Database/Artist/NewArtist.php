	...
	public static function getFormStructure() : array {
		return [
			...
			[
				...
				"after_html" => '<p class="col s12">This will be the link to your page: <strong id="newartist-url-sample" data-base="'.(preg_replace('/New\/?$/', '', \Catalyst\Page\UniversalFunctions::getRequestUrl())).'">'.(preg_replace('/New\/?$/', '', \Catalyst\Page\UniversalFunctions::getRequestUrl())).'</strong></p>'
			],
			[
				"name" => "desc",
				"wrapper_classes" => "col s12",
