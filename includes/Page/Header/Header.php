...
class Header {
	const SCRIPTS = [
		["https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js", "async", "defer", 'crossorigin="anonymous"'],
		["https://cdnjs.cloudflare.com/ajax/libs/materialize/0.99.0/js/materialize.js", 'crossorigin="anonymous"'],
		["https://cdnjs.cloudflare.com/ajax/libs/draggable/1.0.0-beta.3/draggable.bundle.min.js", "async", 'crossorigin="anonymous"'],
		["https://cdn.rawgit.com/namuol/cheet.js/master/cheet.min.js", "async", "defer", 'crossorigin="anonymous"'],
		["https://www.google.com/recaptcha/api.js", "defer"],
		[ROOTDIR."js/markdown-it.js", "async", "defer"],
		[ROOTDIR."js/jq-ajax-progress.js", "async", "defer"],
